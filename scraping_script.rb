# to run, start pry normally, not bin/console and load the file. It will do the rest
require "nokogiri"
require "pry"
require "httparty"
require "yaml"
...
def parse_remote_data(counter, table)
  output = {"#{counter.to_s}" => {}}
...
File.open('test/valid_numbers.yml', 'w')  {|f| f.write @output_hash.to_yaml }
